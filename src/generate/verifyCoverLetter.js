...
const sample = { version: 1, opening: "A ".repeat(50), bodyParagraphs: ["B ".repeat(50), "C ".repeat(50)], closing: "D ".repeat(50), claimEvidence: [{ sentence: "Sample factual draft", evidenceIds: ["sample-evidence"] }] };
